...
만약 언제라도 저희 애플리케이션이 귀하의 Google 계정에 접근하는 것을 원치 않으시면, Google 계정 설정("보안" > "계정 접근 권한이 있는 타사 앱")에서 이 권한을 철회할 수 있습니다. 권한이 철회되면, 저희는 더 이상 귀하의 Google 계정에서 추가 정보를 수집할 수 없습니다.
